    ...
    <div className="w-full space-y-4 mt-5">
      ...
      <div className="py-3 space-y-3 mx-10">
        ...
        <div className="flex items-center gap-x-3">
          <RiGitBranchFill className="text-[#f1593a]" />
          <p>Branch : {pricing?.branch !== 0 ? pricing?.branch : "Custom"}</p>
        </div>
        <div className="flex items-center gap-x-3">
          <FaProductHunt className="text-[#f1593a]" />
          <p>
            Products : {pricing?.product !== 0 ? pricing?.product : "Custom"}
          </p>
        </div>
        <div className="flex items-center gap-x-3">
          <FaUsers className="text-[#f1593a]" />
          <p>Staffs : {pricing?.staff !== 0 ? pricing?.staff : "Custom"}</p>
        </div>
        <div className="flex items-center gap-x-3">
          <TbReport className="text-[#f1593a]" />
          <p>
            Advance Report :{" "}
            {pricing?.advance_report === "No" ? (
              <IoMdClose className="inline text-red-600 text-xl" />
            ) : (
              <TiTick className="inline text-green-600 text-xl" />
            )}
          </p>
        </div>
        {/* <div className="py-3 mx-2 sm:mx-10 xl:mx-20"></div> */}
        {/*  */}
        {/* <div className="flex items-center gap-3 text-xs">
          <Image src={images?.tick} alt="ebitans image" />
          <p className={`${styles.paragraph} ${styles.archivo}`}>
