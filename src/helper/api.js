...
export const fetchBlogSitemapData = async () => {
  try {
    const response = await fetch(`${baseUrl}/blog/site-map`, {
      next: { revalidate: 10 },
    });
    const data = await response.json();
    return data?.results;
...
export const fetchBlogPopularData = async () => {
  try {
    const response = await fetch(`${baseUrl}/blog/popular`, {
      next: { revalidate: 10 },
    });
    const data = await response.json();
    return data?.results?.data;
...
export const fetchBlogTypeData = async () => {
  try {
    const response = await fetch(`${baseUrl}/blog/types`, {
      next: { revalidate: 10 },
    });
    const data = await response.json();
...
export const fetchTypeWiseBlogData = async (blogTypeId, typePage) => {
  try {
    const response = await fetch(
      `${baseUrl}/blog/types/${blogTypeId}${typePage}`,
      { next: { revalidate: 10 } }
    );
    const data = await response.json();
    return data;
...
export const fetchPseSearch = async (searchTxt, allProductSlug) => {
  try {
    const response = await fetch(
      `${baseUrl}/pse/products/product-by-category?name=${searchTxt}&slug=${allProductSlug?.slug}`
    );
    const data = await response.json();
    return data;
  } catch (error) {
